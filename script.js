document.addEventListener('DOMContentLoaded', () => {
    ...
    // Migration script to update old chat formats
    Object.keys(conversations).forEach(id => {
        if (Array.isArray(conversations[id]) || !conversations[id].messages) {
             conversations[id] = { messages: Array.isArray(conversations[id]) ? conversations[id] : [], isPinned: false };
        }
    });
